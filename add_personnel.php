                    ...
                    <div class="card">
                        <div class = "panel panel-primary">
                            <div class = "panel-heading">
                                <h4>BSU PERSONNEL INFORMATION</h4>
                            </div>
                        </div>
                        <div class="body">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                                ...
                                                <select class="form-control show-tick" name="per_campus">
                                                    <option></option>
                                                    <option>BSU Bugias Campus</option>
                                                    <option>BSU Bokod Campus</option>
                                                    <option>BSU Main-La Trinidad Campus</option>
                                                    <option>BSU Kapangan Campus</option>
                                                </select>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
